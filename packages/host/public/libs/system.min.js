...
!(function () {
  ...
  function d(t, n, r) {
    ...
    P && Object.defineProperty(s, P, { value: "Module" });
    var u = Promise.resolve()
        ...
        .then(
          ...
          function (e) {
            throw ((i.e = null), (i.er = e), l(t, i, e, !0), e);
          }
        ),
      c = u.then(function (e) {
        return Promise.all(
  ...
  var I,
    R,
    W = Promise.resolve(),
    T = { imports: {}, scopes: {}, depcache: {}, integrity: {} },
    A = w;
  if (
    ((L.prepareImport = function (e) {
      return (A || e) && (m(), (A = !1)), W;
    }),
    w && (m(), window.addEventListener("DOMContentLoaded", m)),
    (L.addImportMap = function (e, t) {
      i(e, t || g, T);
    }),
    w)
  ) {
    window.addEventListener("error", function (e) {
      (_ = e.filename), (J = e.error);
    });
    var N = location.origin;
  }
  L.createScript = function (e) {
  ...
  var _,
    ...
    U = L.register;
  (L.register = function (e, t) {
    if (w && "loading" === document.readyState && "string" != typeof e) {
    ...
    (L.instantiate = function (t, n) {
      var r = k[t];
      if (r) return delete k[t], r;
      var i = this;
      return Promise.resolve(L.createScript(t)).then(function (r) {
        return new Promise(function (o, s) {
          r.addEventListener("error", function () {
            s(Error(e(3, "Error loading " + t + (n ? " from " + n : ""))));
          }),
            r.addEventListener("load", function () {
              if ((document.head.removeChild(r), _ === t)) s(J);
              else {
                var e = i.getRegister(t);
                e && e[0] === I && clearTimeout(R), o(e);
              }
            }),
  ...
  var F = L.instantiate;
  (L.instantiate = function (e, t) {
    var n = T.depcache[e];
    if (n) for (var r = 0; r < n.length; r++) d(this, this.resolve(n[r], e), e);
    return F.call(this, e, t);
  }),
    b &&
      "function" == typeof importScripts &&
      (L.instantiate = function (e) {
        var t = this;
    ...
    (L.set = function (t, n) {
      ...
      q && "Module" === n[q]
        ...
        : ((r = Object.assign(Object.create(null), n)),
          q && Object.defineProperty(r, q, { value: "Module" }));
